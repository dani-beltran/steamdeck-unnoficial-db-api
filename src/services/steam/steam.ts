...
export const getSteamdeckVerificationStatus = async (
	gameId: number,
): Promise<STEAMDECK_VERIFICATION_STATUS | undefined> => {
	try {
		...
		// resolved_category values: 0 = Unknown, 1 = Unsupported, 2 = Playable, 3 = Verified
