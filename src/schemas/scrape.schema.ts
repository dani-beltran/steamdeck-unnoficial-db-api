...
const structuredScrapedContentSchema = sectionSchema.omit({ id: true }).partial().extend({
    title: z.string(),
    url: z.url(),
    timestamp: z.string(),
...
export const inputScrapeSchema = scrapeSchema.omit({ created_at: true, updated_at: true });
